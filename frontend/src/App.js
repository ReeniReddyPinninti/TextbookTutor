...
//         />
//         <button onClick={handleFaq}>Ask</button>
//         {faqAnswer && <p><strong>Answer:</strong> {faqAnswer}</p>}
//       </div>
...
//         <div><h3>Total QA Score: {
//           (qaScores.reduce((a, q) => a + parseFloat(q.score || 0), 0) / qaScores.length).toFixed(1)
//         } / 10</h3></div>
//       )}
//     </div>
//   );
